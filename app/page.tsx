...
export default function LaurifyHomepage() {
  ...
  return (
    ...
    >
      ...
      {/* GALLERY */}
      <GalleryCarousel ornament={dict.contact.gallery} title={dict.contact.galleryTitle} />

      {/* GOOGLE REVIEWS */}
      <section style={{ background: "var(--cream)", padding: "clamp(3rem, 8vw, 6rem) clamp(1.5rem, 5vw, 3rem)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            <div className="ornament sans">✦ &nbsp; {dict.contact.googleReviews} &nbsp; ✦</div>
            <div className="divider divider-center" />
          </div>
            ...
            <div>
              ...
              >
                {(["name", "contact", "message"] as const).map((field) => {
                  const labels = { name: dict.contact.formName, contact: dict.contact.formContact, message: dict.contact.formMessage };
                ...
                {contactState === "sent" ? (
                  ...
                  >
                    {contactState === "sending" ? dict.contact.formSending : dict.contact.formSend}
                  </button>
                )}
                {contactState === "error" && (
              ...
              <div style={{ marginTop: "1rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                ...
                <span className="sans" style={{ fontSize: "0.6rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--taupe)" }}>{dict.contact.formOr}</span>
                <div style={{ flex: 1, height: "1px", background: "rgba(10,31,72,0.1)" }} />
              </div>
